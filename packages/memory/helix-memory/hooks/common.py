...
# Set OLLAMA_REMOTE_URL env var to enable remote GPU (e.g., via Tailscale)
OLLAMA_REMOTE = os.environ.get("OLLAMA_REMOTE_URL", "")
OLLAMA_LOCAL = os.environ.get("OLLAMA_URL", "http://localhost:11434")
...
def detect_project(cwd: str) -> str:
    ...
    SKIP_DIRS = {'wordpress', 'wp-content', 'plugins', 'themes', 'Sites',
                 'Tools', 'Projects', 'Documents', 'home',
                 'Users', username, 'hooks', 'src', 'lib', 'node_modules',
                 '.wp-test', 'sites'}
